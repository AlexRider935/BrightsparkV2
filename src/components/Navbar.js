    ...
    return (
        <header className="fixed top-0 w-full z-50 font-sans">
            <div className="container mx-auto flex h-24 items-center justify-between px-6">
                <div className={`h-16 aspect-[260/64] flex items-center justify-center rounded-full shadow-lg ${podBackground}`}>
                ...
                <div className={`hidden items-center gap-4 rounded-full p-3 shadow-lg md:flex ${podBackground}`}>
                    <nav
                        ref={navRef}
                    ...
                    <Link href="/portal/login" className="rounded-full bg-brand-gold px-6 py-2 text-sm font-bold text-dark-navy transition-transform duration-300 hover:scale-105">
                        Student Portal
                    </Link>
                </div>
