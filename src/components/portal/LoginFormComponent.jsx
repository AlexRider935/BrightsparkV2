...
// This component contains the form logic and can be reused
export default function LoginFormComponent({ roleTitle }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      router.push("/portal/dashboard"); // The dashboard will redirect to the correct page
    } catch (err) {
  ...
  return (
    <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/5 p-8 text-center backdrop-blur-lg">
      <h1 className="text-3xl font-bold text-white mb-2">{roleTitle} Portal</h1>
