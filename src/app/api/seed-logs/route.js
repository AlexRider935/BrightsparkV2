...
export async function GET() {
    try {
        console.log("Database initialization process started for Activity Logs...");

        // Initialize only the 'activityLogs' collection.
        const logStatus = await initializeCollection('activityLogs');
