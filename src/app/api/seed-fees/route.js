...
export async function GET() {
    try {
        console.log("Database initialization process started for Fees...");

        // Initialize only the 'feeTransactions' collection.
        const feeStatus = await initializeCollection('feeTransactions');
