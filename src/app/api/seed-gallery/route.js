...
export async function GET() {
    try {
        console.log("Database initialization process started for Gallery...");

        // Initialize only the 'galleryAlbums' collection.
        const galleryStatus = await initializeCollection('galleryAlbums');

        console.log("Database initialization process finished.");
        return NextResponse.json({
            message: 'Initialization complete.',
            details: [galleryStatus]
        });
    } catch (error) {
