...
export async function GET() {
    try {
        console.log("Database initialization process started for Materials...");

        // Initialize only the 'materials' collection.
        const materialStatus = await initializeCollection('materials');
