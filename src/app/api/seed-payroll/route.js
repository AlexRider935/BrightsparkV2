...
export async function GET() {
    try {
        console.log("Database initialization process started for Expenses...");

        // Initialize only the 'expenses' collection.
        const expenseStatus = await initializeCollection('expenses');

        console.log("Database initialization process finished.");
        return NextResponse.json({
            message: 'Initialization complete.',
            details: [expenseStatus]
        });
    } catch (error) {
