...
export async function GET() {
    try {
        console.log("Database initialization process started for Attendance...");

        // Initialize only the 'attendanceRecords' collection.
        const attendanceStatus = await initializeCollection('attendanceRecords');
